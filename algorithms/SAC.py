...
class SAC(object):
    ...
    def load(self, filename, evaluate=False):
        ...
        self.critic_optim.load_state_dict(torch.load(filename + "_critic_optimizer", map_location=torch.device('cpu'), weights_only=True))
        self.critic_target = copy.deepcopy(self.critic)
        
        self.policy.load_state_dict(torch.load(filename + "_actor", map_location=torch.device('cpu'), weights_only=True))
        self.policy_optim.load_state_dict(torch.load(filename + "_actor_optimizer", map_location=torch.device('cpu'), weights_only=True))
